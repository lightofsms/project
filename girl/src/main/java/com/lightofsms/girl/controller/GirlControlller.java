...
import com.lightofsms.girl.pojo.ResultBean;
...
public class GirlControlller {
    ...
    @GetMapping("/girls")
    public Result<java.util.List<Girl>> getGirls() {
        return new Result<>(0, "success", girlService.findALl());
    }

    @GetMapping("/girl")
    public ResultBean<?> getGirl(int id) {
